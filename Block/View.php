...
use \Magento\Catalog\Block\Product\View as Views;
/**
 * Class View
 * @api
...
class View extends \Magento\Framework\View\Element\Template implements \Magento\Framework\DataObject\IdentityInterface
{
    ...
    {
//        $vendorAttribute=$this->vendorRepository->getCollection();
//        $id=$this->getRequest()->getParam("id");
//        $vendorAttribute->addFieldToFilter('id', $id);
//        return $vendorAttribute;
        $vendorAttribute=$this->vendorRepository->load($this->getRequest()->getParam("id"));
        return $vendorAttribute;
